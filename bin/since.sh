...
# Displays the time since $1 in a human readable format (e.g. 4h 25m 55s). If given a
# file, the modified time is used. If $1 == "--", then this script acts as a converter,
# converting $2 into human a readable format, e.g. since -- 72 #=> 1m 12s
